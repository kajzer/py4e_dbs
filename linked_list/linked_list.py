...
class LinkedList:
    ...
    def pop(self, position = None):
        ...
        """
        # Corected this line so the pop will work withut specifiying argument for pop
...
if __name__ == "__main__":
    ...
    ll.add('e')
    ll.add('H')
    print("print after adding items")
    ll.printList()
    ll.insert(3, 'p')
    print("printing after inserting p")
    ll.printList()
    ll.append('z')
    print("printing after appending")
    ll.printList()
    ret_value_pop = ll.pop(2)
    print("printing after pop(2) and the returned value is: ", ret_value_pop)
    ll.printList()
    print("finding index of p: ", ll.index('p'))